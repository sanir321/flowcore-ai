            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <div className="bg-white rounded-t-3xl shadow-2xl overflow-hidden border border-white/10 relative z-10">
                        {/* Header */}
                        <div className="h-14 bg-gray-50 border-b border-gray-100 flex items-center px-6 justify-between">
                            ...
                            <div className="text-xs font-mono text-gray-400">flowcore_agent_v2.1.0</div>
                        </div>

                        {/* Content Area */}
                        <div className="p-8 bg-white min-h-[300px] flex gap-8 text-left">
                            {/* Sidebar List */}
                            <div className="w-64 flex-shrink-0 border-r border-gray-100 pr-8 space-y-4">
                            ...
                            <div className="flex-1 space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="bg-gray-100 rounded-2xl rounded-tl-sm p-4 text-sm text-gray-700 max-w-md">
                                ...
                                <div className="flex gap-4 flex-row-reverse">
                                    ...
                                    <div className="bg-white border border-gray-200 shadow-sm rounded-2xl rounded-tr-sm p-4 text-sm text-gray-900 max-w-md">
